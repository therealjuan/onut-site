...
const MemoreyPage = ({ data, location }) => {
    ...
    return(
        ...
        <div className="work-layout" id={projects[3].id}>
            <div className="video-summary">
                <iframe title="video" src={projects[3].video} width="100%" height="100%" frameBorder="0"></iframe>
            </div>
            <aside className="explanation">
                <div className="column" dangerouslySetInnerHTML={{__html: projects[3].leftColumn }} />
                <div className="column" dangerouslySetInnerHTML={{__html: projects[3].rightColumn }} />
            </aside>
        </div>
        <div className="title">
            <hr className="top" />
            <h3>{projects[3].title}</h3>
            <h4>{projects[3].date}</h4>
            <hr className="bottom" />
        </div>
